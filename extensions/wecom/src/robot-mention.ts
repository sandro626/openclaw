 ...
 */
export function getRobotInfoByAccountId(cfg: ClawdbotConfig, accountId: string): RobotInfo | undefined {
...
export function parseRobotMentionsFromText(
  ...
  for (const pattern of patterns) {
    ...
    while ((match = pattern.exec(text)) !== null) {
      ...
      const robotInfo = robotNameMap.get(mentionName) ||
                        robotNameMap.get(mentionNameLower);
