...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  {
    dirName: "mysql-readonly",
    idHint: "mysql-readonly",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    publicSurfaceArtifacts: ["api.js"],
    packageName: "@openclaw/mysql-readonly",
    packageVersion: "2026.3.21",
    packageDescription: "OpenClaw read-only MySQL query plugin",
    packageManifest: {
      extensions: ["./index.ts"],
      install: {
        npmSpec: "@openclaw/mysql-readonly",
        localPath: "extensions/mysql-readonly",
        defaultChoice: "npm",
      },
    },
    manifest: {
      ...
      configSchema: {
        ...
        properties: {
          host: {
            type: "string",
            description: "MySQL host name or IP.",
          },
          port: {
            type: "number",
          ...
          user: {
            type: "string",
            description: "Read-only MySQL username.",
          },
          password: {
            type: "string",
            description: "Read-only MySQL password.",
            "x-sensitive": true,
          },
          database: {
            type: "string",
          ...
          allowedTables: {
            type: "array",
            description: "Optional whitelist of tables that agents may inspect.",
            items: {
              type: "string",
            },
          },
          ...
          maxRows: {
            type: "number",
            description: "Maximum rows returned to the agent.",
          },
          ssl: {
            type: "boolean",
            description: "Whether to require TLS for MySQL connections.",
          },
        },
  ...
  },
  {
    ...
    publicSurfaceArtifacts: ["api.js"],
    packageName: "@openclaw/wecom",
    packageVersion: "1.0.0",
    packageDescription: "WeCom (企业微信) channel plugin for OpenClaw",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
  ...
  },
  {
    ...
    publicSurfaceArtifacts: ["api.js"],
    packageName: "@openclaw/zentao",
    packageVersion: "2026.3.21",
    packageDescription: "OpenClaw Zentao API integration plugin",
    packageManifest: {
      extensions: ["./index.ts"],
      install: {
        npmSpec: "@openclaw/zentao",
        localPath: "extensions/zentao",
        defaultChoice: "npm",
      },
    },
    manifest: {
      ...
      configSchema: {
        ...
        properties: {
          baseUrl: {
            type: "string",
            description: "Base HTTPS URL of the Zentao instance.",
          },
          apiVersion: {
            type: "string",
            enum: ["v1"],
            description: "REST API version to use.",
          },
          account: {
            type: "string",
            description:
              "Optional fallback Zentao account used when the current agent has no params.zentao mapping.",
          },
          password: {
            type: "string",
            description: "Optional fallback Zentao password or secret reference.",
            "x-sensitive": true,
          },
          accountsByAgent: {
            type: "object",
            description:
              "Legacy plugin-level per-agent credential map. Prefer agents.list[].params.zentao.",
            additionalProperties: {
              type: "object",
              additionalProperties: false,
              properties: {
          ...
          mode: {
            ...
            description: "Whether write actions are allowed.",
          },
          allowedProducts: {
            type: "array",
            items: {
      ...
      skills: ["./skills"],
      name: "Zentao",
      description: "Zentao RESTful API integration for structured work-item access and management.",
    },
  },
] as const;
