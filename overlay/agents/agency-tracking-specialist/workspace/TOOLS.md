...
- `built-in browser tool`
  Use for landing pages, ads, and public funnel review.
- `tavily-search`
  Use for benchmark research, channel trends, and public paid-media context.
- `analyze`
  Use to structure hypothesis trees, experiment design, and optimization notes.
- `feishu-doc-manager`
  Use for media plans, audit notes, and test backlogs.
