...
- `tavily-search`
  Use for trend research, competitor context, and public market signals.
- `analyze`
  Use to structure audience logic, messaging, hooks, and growth hypotheses.
- `feishu-doc-manager`
  Use for briefs, calendars, messaging maps, and strategy notes.
