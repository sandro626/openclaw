...
- `tavily-search`
  Use for genre research, tooling context, and production references.
- `analyze`
  Use to structure mechanics, production tradeoffs, and review notes.
- `feishu-doc-manager`
  Use for design notes, production outlines, and creative briefs.
- `claude-code-task`
