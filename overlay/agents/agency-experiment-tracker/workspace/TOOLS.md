...
- `analyze`
  Use for workflow framing, milestone structure, and dependency mapping.
- `feishu-doc-manager`
  Use for plans, handoff notes, status summaries, and operating docs.
- `built-in browser tool`
  Use for public workflow references and process-pattern research.
- `tavily-search`
  Use for methods, templates, and operational benchmark context.
- `claude-code-task`
