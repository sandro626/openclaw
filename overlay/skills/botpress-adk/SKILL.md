...
export const searchProducts = new Autonomous.Tool({
  ...
  description:
    "Search the product catalog. Use when user asks about products, availability, pricing, or wants to browse items.",
...
const result = await execute({
  ...
  // Add tools
  tools: [searchTool, actions.linear.issueCreate.asTool()],
