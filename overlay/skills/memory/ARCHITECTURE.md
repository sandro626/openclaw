...
## Memory Background Agent Behavior
...
├── agents/
│   └── hippocampus-agent.md # Legacy-compatible background agent instructions
├── scripts/
│   ├── capture.sh
│   ├── consolidate.sh
│   ├── reflect.sh
│   └── run-hippocampus.sh   # Trigger the legacy-compatible agent
└── prompts/
    └── ...
