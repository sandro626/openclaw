#!/bin/bash
# log-event.sh — Log memory events to brain-events.jsonl
# Part of the memory skill (upstream registry alias: @ImpKind/hippocampus)
#
...
# Keep the historical event type for dashboard/backfill compatibility.
# Build JSON object
