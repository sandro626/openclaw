...
#
# Environment:
#   WORKSPACE - OpenClaw workspace (default: $HOME/.openclaw/workspace)
...
WORKSPACE = (
    ...
    or os.path.join(os.environ.get('HOME', ''), '.openclaw', 'workspace')
)
...
echo "  openclaw sessions:spawn --task 'Run $SKILL_DIR/scripts/summarize-pending.sh'"
