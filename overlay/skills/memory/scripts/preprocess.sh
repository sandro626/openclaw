#!/bin/bash
# Preprocess ALL session transcripts into clean signals for memory encoding
...
#   OPENCLAW_HOME - Runtime root (default: $HOME/.openclaw)
#   TRANSCRIPT_DIR - Explicit transcript directory override
...
TRANSCRIPT_DIR="${TRANSCRIPT_DIR:-$OPENCLAW_HOME/agents/$AGENT_ID/sessions}"
